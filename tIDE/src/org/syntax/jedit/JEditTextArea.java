...
public class JEditTextArea extends JComponent
{
	...
	//The name of the file associated with this text area
	String name;

	//Keeps track of whether the current file has been saved
	...
	public JEditTextArea(String name)
	{
		this(TextAreaDefaults.getDefaults());
		this.name = name;
	}
	...
	public JEditTextArea(TextAreaDefaults defaults)
	{
		...
		painter.addMouseWheelListener(new MouseWheelHandler());//TODO
	 ...
	 * Modified to "ignore" pure comment lines
	 */
	...
	public void processKeyEvent(KeyEvent evt)
	{
		...
		case KeyEvent.KEY_TYPED:
			...
			if (evt.getKeyCode() != KeyEvent.VK_DOWN && evt.getKeyCode() != KeyEvent.VK_UP && evt.getKeyCode() != KeyEvent.VK_LEFT && evt.getKeyCode() != KeyEvent.VK_RIGHT && evt.getKeyCode() != KeyEvent.VK_SHIFT && evt.getKeyCode() != KeyEvent.VK_CONTROL)
				setSaved(false);
			break;
	 ...
	 * Mouse wheel listener to enable scrolling in the text area
	 *
	 */
	class MouseWheelHandler implements MouseWheelListener
	{
		...
		public void mouseWheelMoved(MouseWheelEvent e) {
			requestFocus();
			vertical.setValue(vertical.getValue() + e.getWheelRotation()*3);
		}
	...
	class MouseHandler extends MouseAdapter
	{
		...
		{
			requestFocus();
			//Reset selection colour if it was changed for error highlighting
			getPainter().setSelectionColor(new Color(204, 204, 255));
	...
	//Appends a line to the text of this text area
