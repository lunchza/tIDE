...
public abstract class InputHandler extends KeyAdapter
{
	...
	static //clipboard buffer for ctrl-z (undo) function
	UnlimitedClipboard clipboard;
	...
	public static class backspace implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent evt)
		{
			...
			clipboard.update(textArea.getText());
	...
	public static UnlimitedClipboard getClipBoard()
	{
		return clipboard;
	}
}
